...
if __name__ == "__main__":
    ...
    print('Directions: ', windDirections)
    print('Frequencies: ', windFrequencies)
    print('Speeds: ', windSpeeds)
    ...
    np.savetxt('XYZtest.txt',np.c_[prob['turbineX'],prob['turbineY'],prob['turbineZ']])
    ...
    tdCOE = prob['COE']
    tdAEP = prob['AEP']
    np.savetxt('XYtest.txt',np.c_[prob['turbineX'],prob['turbineY'],prob['turbineZ']])
