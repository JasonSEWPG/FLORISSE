...
Pulse
Graphs
FLORISSE/src/florisse/floris.f90
19aa341 7 days ago
@jaredthomas68 jaredthomas68 corrected gradients for small logic change made in cosine factor calc…
2078 lines (1919 sloc) 80.4 KB
! Flow field calculations have been intentionally left out to save development time.
! The flow field can be calculated using the pure python version of floris 
