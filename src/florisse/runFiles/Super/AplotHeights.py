...
if __name__=='__main__':
    ...
    opt_filenameXYZ = 'XYZ_%s_'%space+numRows+'_'+shear_Exp+'_'+optimizer+'_'+minSpacing+'_'+maxD+'.txt'
    opt_filename_dt = 'dt_%s_'%space+numRows+'_'+shear_Exp+'_'+optimizer+'_'+minSpacing+'_'+maxD+'.txt'
    opt_filenameXYZ = 'XYZ_PLEASEWORK_6.0D_2.0.txt'
    opt_filename_dt = 'dt_PLEASEWORK_6.0D_2.0.txt'
