...
if __name__=="__main__":
    ...
    root.deriv_options['step_size'] = 1.E-3
    ...
    np.savetxt('SP5XYZ_warm_%s.txt'%shearExp, np.c_[prob['turbineX'], prob['turbineY'], prob['turbineZ']], header="turbineX, turbineY, turbineZ")
    np.savetxt('SP5dt_warm_%s.txt'%shearExp, np.c_[prob['d_paramH1'], prob['d_paramH2'], prob['t_paramH1'], prob['t_paramH2'],], header="d_paramH1, t_paramH1")
