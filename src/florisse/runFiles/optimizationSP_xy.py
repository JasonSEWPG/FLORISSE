...
if __name__=="__main__":
    ...
    if farm == "Grid":
        nRows = 5
        nTurbs = nRows**2
        spacing = 3.1  # turbine grid spacing in diameters
    ...
    np.savetxt('SPXYZ_xy_%s.txt'%shearExp, np.c_[prob['turbineX'], prob['turbineY'], prob['turbineZ']], header="turbineX, turbineY, turbineZ")
    np.savetxt('SPdt_xy_%s.txt'%shearExp, np.c_[prob['d_paramH1'], prob['d_paramH2'], prob['t_paramH1'], prob['t_paramH2'],], header="d_paramH1, t_paramH1")
