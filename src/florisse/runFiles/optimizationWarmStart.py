...
if __name__=="__main__":
    ...
    opt_filenameXYZ = 'XYZ_warm_0.13.txt'
    ...
    shear_ex = np.array([0.12,0.11,0.1,0.09,0.08])
    ...
    for i in range(len(shear_ex)):
        ...
        prob.driver.opt_settings['Summary file'] = 'SNOPT_warm_%s.out'%shearExp
	...
	prob.driver.opt_settings['Function precision'] = 1E-8
        ...
        np.savetxt('XYZ_warm_%s.txt'%shearExp, np.c_[prob['turbineX'], prob['turbineY'], prob['turbineZ']], header="turbineX, turbineY, turbineZ")
        np.savetxt('dt_warm_%s.txt'%shearExp, np.c_[prob['d_paramH1'], prob['d_paramH2'], prob['t_paramH1'], prob['t_paramH2']], header="d_paramH1, d_paramH2, t_paramH1, t_paramH2")
        #
        ...
        turbineH1 = np.float(prob['turbineH1'])
        turbineH2 = np.float(prob['turbineH2'])
