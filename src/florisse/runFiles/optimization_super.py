...
if __name__=="__main__":
    ...
    prob.driver.opt_settings['Summary file'] = 'SNOPT_3_same_super_6.3D_%s.out'%shearExp
    ...
    np.savetxt('XYZ_3_same_super_6.3D_%s.txt'%shearExp, np.c_[prob['turbineX'], prob['turbineY'], prob['turbineZ']], header="turbineX, turbineY, turbineZ")
    np.savetxt('dt_3_same_super_6.3D_%s.txt'%shearExp, np.c_[prob['d_paramH1'], prob['d_paramH2'], prob['t_paramH1'], prob['t_paramH2']], header="d_paramH1, d_paramH2, t_paramH1, t_paramH2")
