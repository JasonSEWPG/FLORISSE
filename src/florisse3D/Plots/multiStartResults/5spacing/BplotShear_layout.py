...
if __name__=="__main__":
    layoutfile = 'src/florisse3D/Plots/multiStartResults/5spacing/Bshear_layout.txt'
    optlayout = open(layoutfile)
    optimizedlayout = np.loadtxt(optlayout)
    layout = optimizedlayout[:,1]

    # layoutfile_yaw = 'src/florisse3D/Plots/multiStartResults/5spacing/Bshear_layout_YAW.txt'
    # optlayout_yaw = open(layoutfile_yaw)
    # optimizedlayout_yaw = np.loadtxt(optlayout_yaw)
    # layout_yaw = optimizedlayout_yaw[:,1]

    layoutfile = 'src/florisse3D/Plots/multiStartResults/5spacing/Bshear_layout_1.txt'
    optlayout = open(layoutfile)
    optimizedlayout = np.loadtxt(optlayout)
    layout_1group = optimizedlayout[:,1]

    # layoutfile_yaw = 'src/florisse3D/Plots/multiStartResults/5spacing/Bshear_layout_1_YAW.txt'
    # optlayout_yaw = open(layoutfile_yaw)
    # optimizedlayout_yaw = np.loadtxt(optlayout_yaw)
    # layout_1group_yaw = optimizedlayout_yaw[:,1]

    layoutfile = 'src/florisse3D/Plots/multiStartResults/5spacing/Bshear_layout_2.txt'
    optlayout = open(layoutfile)
    optimizedlayout = np.loadtxt(optlayout)
    layout_2group = optimizedlayout[:,1]
    #
    # layoutfile_yaw = 'src/florisse3D/Plots/multiStartResults/5spacing/Bshear_layout_2_YAW.txt'
    # optlayout_yaw = open(layoutfile_yaw)
    # optimizedlayout_yaw = np.loadtxt(optlayout_yaw)
