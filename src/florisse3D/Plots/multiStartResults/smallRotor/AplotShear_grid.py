...
if __name__=="__main__":
    gridfile = 'src/florisse3D/Plots/multiStartResults/smallRotor/Ashear_grid.txt'
    optgrid = open(gridfile)
    optimizedgrid = np.loadtxt(optgrid)
    grid = optimizedgrid[:,1]

    gridfile_yaw = 'src/florisse3D/Plots/multiStartResults/smallRotor/Ashear_gridYAW.txt'
    optgrid_yaw = open(gridfile_yaw)
    optimizedgrid_yaw = np.loadtxt(optgrid_yaw)
    grid_yaw = optimizedgrid_yaw[:,1]

    gridfile = 'src/florisse3D/Plots/multiStartResults/smallRotor/Ashear_grid_1group.txt'
    optgrid = open(gridfile)
    optimizedgrid = np.loadtxt(optgrid)
    grid_1group = optimizedgrid[:,1]

    gridfile_yaw = 'src/florisse3D/Plots/multiStartResults/smallRotor/Ashear_grid_1groupYAW.txt'
    optgrid_yaw = open(gridfile_yaw)
    optimizedgrid_yaw = np.loadtxt(optgrid_yaw)
    grid_1group_yaw = optimizedgrid_yaw[:,1]

    gridfile = 'src/florisse3D/Plots/multiStartResults/smallRotor/Ashear_grid_2group.txt'
    optgrid = open(gridfile)
    optimizedgrid = np.loadtxt(optgrid)
    grid_2group = optimizedgrid[:,1]

    gridfile_yaw = 'src/florisse3D/Plots/multiStartResults/smallRotor/Ashear_grid_2groupYAW.txt'
    optgrid_yaw = open(gridfile_yaw)
    optimizedgrid_yaw = np.loadtxt(optgrid_yaw)
