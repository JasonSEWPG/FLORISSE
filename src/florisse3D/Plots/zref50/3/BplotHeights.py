...
if __name__=="__main__":
    ...
    file = 'src/florisse3D/Plots/zref50/3/B2heights.txt'
    opt = open(file)
    ...
    ax.plot(shearExp[0:3], group20_2[0:3], 'r',linewidth=1.5)
    ax.plot(shearExp[13:23], group20_2[13:23], 'r',linewidth=1.5)
    ax.plot(shearExp[2:14], group20_2[2:14], 'r',linewidth=3,label='hub height, group 2')
    ax.plot([0,1],[90.,90.],'--k')#, label='90 m')
    ax.text(0.16,82,'90 m')
    ...
    plt.title('Small Farm: Large Rotor: Heights')
    plt.legend(loc=4)
    plt.tight_layout()
