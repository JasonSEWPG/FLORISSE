...
if __name__=="__main__":
    layoutfile = 'src/florisse3D/Plots/zref50/4/CoupleLayout/Ashear_layout.txt'
    optlayout = open(layoutfile)
    optimizedlayout = np.loadtxt(optlayout)
    layout = optimizedlayout[:,1]

    #
    layoutfile = 'src/florisse3D/Plots/zref50/4/CoupleLayout/Ashear_layout_1.txt'
    optlayout = open(layoutfile)
    optimizedlayout = np.loadtxt(optlayout)
    layout_1group = optimizedlayout[:,1]
    #

    layoutfile = 'src/florisse3D/Plots/zref50/4/CoupleLayout/Ashear_layout_2.txt'
    optlayout = open(layoutfile)
    optimizedlayout = np.loadtxt(optlayout)
