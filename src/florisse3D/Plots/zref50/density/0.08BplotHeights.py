...
if __name__=="__main__":
    ...
    file = 'src/florisse3D/Plots/zref50/density/0.08B2heights.txt'
    opt = open(file)
    ...
    ax.plot(density[6:10], group20_2[6:10], 'r',linewidth=3,label='hub height, group 2')
    ax.plot(density[0:7], group20_2[0:7], 'r',linewidth=1.5)
    ...
    plt.title('0.08 Shear Exponent: Large Rotor: Hub Heights', y=1.15)
    plt.tight_layout()
    plt.show()
