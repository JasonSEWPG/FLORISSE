...
if __name__ == '__main__':
    ...
    d[0] =  np.array([5.399348570753399912e+00, 4.980298750150027765e+00, 3.870000000000000107e+00])
    d[1] =  np.array([6.299999999999999822e+00, 4.186628106086838663e+00, 3.870000000000000107e+00])
    d[2] =  np.array([5.351721169604850559e+00, 4.962102673907160089e+00, 3.870000000000000107e+00])
    d[3] =  np.array([5.367283352186814405e+00, 4.969182223300817824e+00, 3.870000000000000107e+00])
    d[4] =  np.array([6.299999999999999822e+00, 4.175892569500547324e+00, 3.870000000000000107e+00])
    d[5] =  np.array([5.386759568452350599e+00, 4.979792029018685895e+00, 3.870000000000000107e+00])
    d[6] =  np.array([5.344252325899357281e+00, 4.959666540248499622e+00, 3.870000000000000107e+00])
    d[7] =  np.array([6.299999999999999822e+00, 4.185986294686922626e+00, 3.870000000000000107e+00])
    d[8] =  np.array([5.350529533709138974e+00, 4.961680192634833730e+00, 3.870000000000000107e+00])
    d[9] =  np.array([5.350529533709138974e+00, 4.961680192634833730e+00, 3.870000000000000107e+00])

    t[0] =  np.array([2.746945027897581409e-02, 1.851184818371975557e-02, 1.096092668569927098e-02])
    t[1] =  np.array([2.332992689227660760e-02, 2.204094081092527677e-02, 1.096092657275339263e-02])
    t[2] =  np.array([2.761479848742140475e-02, 1.851661279746331934e-02, 1.096092377358008282e-02])
    t[3] =  np.array([2.756925217400577749e-02, 1.850942470252781719e-02, 1.096092450375994384e-02])
    t[4] =  np.array([2.332313956023539595e-02, 2.210804319707933285e-02, 1.096092677874070491e-02])
    t[5] =  np.array([2.749217367969028838e-02, 1.848620905066535036e-02, 1.096092687083189895e-02])
    t[6] =  np.array([2.763878968047656787e-02, 1.851584123783722724e-02, 1.096092318714530188e-02])
    t[7] =  np.array([2.333434788080595082e-02, 2.203627237053407475e-02, 1.096092497688426134e-02])
    t[8] =  np.array([2.761867602277027350e-02, 1.851639346797228844e-02, 1.096092337960901698e-02])
    t[9] =  np.array([2.761867602277027350e-02, 1.851639346797228844e-02, 1.096092337960901698e-02])

    z[0] =  np.array([9.521833264309607614e+01])
    z[1] =  np.array([9.523973705097066045e+01])
    z[2] =  np.array([9.480745499970007018e+01])
    z[3] =  np.array([9.494890233534322022e+01])
    z[4] =  np.array([9.528820723096849576e+01])
    z[5] =  np.array([9.504973388012047053e+01])
    z[6] =  np.array([9.474612402281117340e+01])
    z[7] =  np.array([9.523926736152895955e+01])
    z[8] =  np.array([9.479744948448031039e+01])
    z[9] =  np.array([9.479744948448031039e+01])
    ...
    # ideal AEP:  array([  4.79349174e+08,   4.79397105e+08,   4.78417267e+08,
    #          4.78738332e+08,   4.79499472e+08,   4.78967045e+08,
    #          4.78277972e+08,   4.79396112e+08,   4.78394546e+08,
    #          4.78394546e+08])
    # AEP:  array([  4.42117253e+08,   4.09654319e+08,   3.82111191e+08,
    #          3.59749609e+08,   3.40904653e+08,   3.23666521e+08,
    #          3.08483305e+08,   2.96109589e+08,   2.83834000e+08,
    #          2.73392282e+08])
    # COE:  array([ 26.60925053,  28.24694774,  29.77874418,  31.26779322,
    #         32.71776639,  34.08668283,  35.41868635,  36.73444765,
    #         37.97234903,  39.18927319])
    # cost:  array([  1.17644088e+10,   1.15714841e+10,   1.13787914e+10,
    #          1.12485764e+10,   1.11536388e+10,   1.10327180e+10,
    #          1.09260734e+10,   1.08774222e+10,   1.07778437e+10,
    #          1.07140448e+10])
    # tower cost:  array([ 18088841.10220274,  18127908.31107989,  17959582.04215072,
    #         18003116.61486003,  18143000.30798149,  18034510.61355077,
    #         17940243.14325566,  18125705.41100818,  17956360.60611325,
    #         17956360.60611325])
    # wake loss:  array([  7.76718151,  14.54801975,  20.13014215,  24.85464721,
    #         28.90406081,  32.42405202,  35.50125177,  38.23279301,
