...
if __name__ == '__main__':
    ...
    d[0] =  np.array([6.299999999999999822e+00, 5.323299115339491294e+00, 3.870000000000000107e+00])
    d[1] =  np.array([6.299999999999999822e+00, 5.324132645789247498e+00, 3.870000000000000107e+00])
    d[2] =  np.array([6.299999999999999822e+00, 5.322091966096111904e+00, 3.870000000000000107e+00])
    d[3] =  np.array([6.299999999999999822e+00, 5.324553690985410093e+00, 3.870000000000000107e+00])
    d[4] =  np.array([6.299999999999999822e+00, 5.325277988873134305e+00, 3.870000000000000107e+00])
    d[5] =  np.array([6.299999999999999822e+00, 5.323974216487974864e+00, 3.870000000000000107e+00])
    d[6] =  np.array([6.299999999999999822e+00, 5.324277875767746693e+00, 3.870000000000000107e+00])
    d[7] =  np.array([6.299999999999999822e+00, 5.324389939442513153e+00, 3.870000000000000107e+00])
    d[8] =  np.array([6.299999999999999822e+00, 5.324404518935883068e+00, 3.870000000000000107e+00])
    d[9] =  np.array([6.299999999999999822e+00, 5.324270028467063653e+00, 3.870000000000000107e+00])

    t[0] =  np.array([1.506528167441534456e-02, 1.039191290038381926e-02, 6.153402721329088998e-03])
    t[1] =  np.array([1.504755394821863553e-02, 1.040744809097768862e-02, 6.154605484807063043e-03])
    t[2] =  np.array([1.506462932384868350e-02, 1.039321855571553356e-02, 6.154799936832858545e-03])
    t[3] =  np.array([1.504640724541160199e-02, 1.040639630254900500e-02, 6.151799377595692890e-03])
    t[4] =  np.array([1.503661961071891921e-02, 1.040903001973797481e-02, 6.153367321587076277e-03])
    t[5] =  np.array([1.505041297908559818e-02, 1.040478605925004851e-02, 6.154735590554830452e-03])
    t[6] =  np.array([1.504711878048994173e-02, 1.040722825517941680e-02, 6.153733977158588192e-03])
    t[7] =  np.array([1.504612986625063209e-02, 1.040692234160247101e-02, 6.155022906396361189e-03])
    t[8] =  np.array([1.504981883350342727e-02, 1.040487653381774388e-02, 6.151325418055071485e-03])
    t[9] =  np.array([1.504785112806259623e-02, 1.040653088334475042e-02, 6.152960992935796805e-03])
    ...
    # ideal AEP:  array([  4.64391003e+08,   4.64391003e+08,   4.64391003e+08,
    #          4.64391003e+08,   4.64391003e+08,   4.64391003e+08,
    #          4.64391003e+08,   4.64391003e+08,   4.64391003e+08,
    #          4.64391003e+08])
    # AEP:  array([  4.05268029e+08,   3.58275363e+08,   3.21528893e+08,
    #          2.91450355e+08,   2.66664000e+08,   2.45912310e+08,
    #          2.28193837e+08,   2.12957009e+08,   1.99708926e+08,
    #          1.88099199e+08])
    # COE:  array([  54.33129824,   60.66073179,   66.88947258,   73.16687023,
    #          79.39911819,   85.58509767,   91.75678192,   97.88460023,
    #         103.97108862,  110.01227823])
    # cost:  array([  2.20187381e+10,   2.17332457e+10,   2.15068981e+10,
    #          2.13245103e+10,   2.11728865e+10,   2.10464291e+10,
    #          2.09383321e+10,   2.08452117e+10,   2.07639544e+10,
    #          2.06932215e+10])
    # tower cost:  array([ 33774506.93540525,  33786426.6871449 ,  33773091.21990221,
    #         33783253.6621712 ,  33781945.53705663,  33784394.32328396,
    #         33785583.4914347 ,  33785413.00867137,  33783138.73046852,
    #         33784616.89087056])
