...
if __name__ == '__main__':
    ...
    ratedPower = np.array([1000.,200.,2000.,3000.,3004.])
    ...
    for i in range(nGroups):
        ...
        print 'Blade Length: ', prob['Rotor%s.bladeLength'%i]
        print 'TowerSE thrust Fx: ', prob['Tower%s_max_thrust.Fx'%i]
        print 'TowerSE speed Fx: ', prob['Tower%s_max_speed.Fx'%i]

        print 'TowerSE thrust Mxx: ', prob['Tower%s_max_thrust.Mxx'%i]
        print 'TowerSE speed Mxx: ', prob['Tower%s_max_speed.Mxx'%i]

        print 'TowerSE thrust Myy: ', prob['Tower%s_max_thrust.Myy'%i]
        print 'TowerSE speed Myy: ', prob['Tower%s_max_speed.Myy'%i]

        print 'MIN HEIGHT: ', prob['minHeight%s.minHeight'%i]

        print 'TowerSE qx: ', prob['Tower%s_max_speed.qx'%i]
        print 'TowerSE qy: ', prob['Tower%s_max_speed.qy'%i]
        print 'TowerSE m: ', prob['Tower%s_max_speed.m'%i]

        print 'TowerSE axial stress: ', prob['Tower%s_max_speed.axial_stress'%i]
        print 'TowerSE shear stress: ', prob['Tower%s_max_speed.shear_stress'%i]
        print 'TowerSE hoop stress: ', prob['Tower%s_max_speed.hoop_stress'%i]

        print 'TowerSE I: ', prob['Tower%s_max_speed.I'%i]
        print 'TowerSE It: ', prob['Tower%s_max_speed.It'%i]

        print 'Fz: ', prob['Tower%s_max_speed.Fz'%i]
        print 'm*9.81: ', prob['Tower%s_max_speed.m'%i]*-9.81
