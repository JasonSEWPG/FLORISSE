...
nDirections = len(wf)
# wd = np.linspace(270.,-90.+360/nDirections, nDirections)
wd = np.linspace(0.,360.-360/nDirections, nDirections)
...
ax.set_rgrids([0.02,0.04,0.06,0.08], angle=-35.)
ax.set_yticklabels(['2%','4%','6%','8%'],fontsize=18,family='serif')
# ax.set_rgrids([6.,8.,10.], angle=-35.)
# ax.set_yticklabels([r'6$\frac{m}{s}$',r'8$\frac{m}{s}$',r'10$\frac{m}{s}$'],fontsize=18,family='serif')
plt.title('Alturas Wind Rose', y=1.09,fontsize=20,family='serif')
plt.tight_layout()
plt.savefig('alturas_rose.pdf',transparent=True)
