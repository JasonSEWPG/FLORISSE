...
from FLORISSE3D.GeneralWindFarmComponents import getTurbineZ, AEPobj, actualSpeeds, speedFreq, get_z
...
if __name__=="__main__":
    ...
    turbineY = np.array([0.,rotor_diameter*2.])
    turbineH1 = 72.
    turbineH2 = 125.
    ...
    for i in range(num):
        ...
        turbineXnew[i] = turbineX+(-10.+i*20./num)*turbine
        turbineYnew[i] = turbineY+(-10.+i*20./num)*turbine
    print d_paramH2new
    print t_paramH2new
    ...
    np.savetxt('continuity6X.txt', np.c_[COE, AEP], header="COE, AEP")
