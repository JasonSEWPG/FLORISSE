...
if __name__ == '__main__':
    ...
    #
    # turbineX = np.array([0.,0.,0.,0.,0.,10.,10.,10.,10.])
    # turbineY = np.array([0.,200.,400.,600.,800.,1000.,1200.,1400.,1600.])
    ...
    if windData == "Amalia":
        ...
        windDirections = np.array([0.,120.,240.])
    ...
    # prob.driver.opt_settings['Summary file'] = 'XYZdt_analytic_%s.out'%spacing
    ...
    # np.savetxt('src/florisse3D/runFiles/Results/XYZ_XYZdt_analytic_%s.txt'%spacing, np.c_[prob['turbineX'], prob['turbineY'], prob['turbineZ']], header="turbineX, turbineY, turbineZ")
    # np.savetxt('src/florisse3D/runFiles/Results/dt_XYZdt_analytic_%s.txt'%spacing, np.c_[prob['d_paramH1'], prob['d_paramH2'], prob['t_paramH1'], prob['t_paramH2'],])
    # np.savetxt('src/florisse3D/runFiles/Results/YAW_XYZdt_analytic_%s.txt'%spacing, np.c_[yawAngles], header="yaw")
