...
if __name__=="__main__":
    ...
    prob.driver.opt_settings['Summary file'] = 'SNOPT_TEST_AEP1dir.out'
    ...
    if use_rotor_components == True:
        ...
        prob['Ct_in'] = Ct
        prob['Cp_in'] = Cp
    prob['floris_params:cos_spread'] = 1.0E12 # turns off cosine spread (just needs to be very large)
    # prob['zref'] = wind_zref
    # prob['z0'] = wind_z0
