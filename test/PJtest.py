...
# class TestRotorStuff(unittest.TestCase):
    ...
    #     #t_param[2] = 0.01
    #     shearExp = 0.15
    #     rotorDiameter = np.random.rand(nGroups)*120.+30.
    #     turbineZ = np.random.rand(nGroups)*75.+50.
    #     """OpenMDAO"""
    #     # rotorDiameter = np.ones(nTurbs)*89.
    #     prob = Problem()
    ...
    #         print i
    #         print 'analytic'
    #         print self.J['AEP', 'rotorDiameter%s'%i]['J_rev']
    #         print 'finite difference'
    #         print self.J['AEP', 'rotorDiameter%s'%i]['J_fd']
    #
    #
    # def test_rotor(self):
    #     for i in range(self.nGroups):
    #         np.testing.assert_allclose(self.J[('AEP', 'rotorDiameter%s'%i)]['J_rev'], self.J[('AEP', 'rotorDiameter%s'%i)]['J_fd'], 1e-6, 1e-6)
    #
